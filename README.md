...
10. **트라이 횟수 통계 확인**: 플래시카드 아래에 표시되는 통계에서 학습 진행 상황을 확인할 수 있습니다.
    - 각 횟수별로 몇 개의 단어가 완료되었는지 확인
    - 각 횟수 레이블(1회, 2회, 3회, 4회, 5회+)을 클릭하면 해당 그룹의 단어 목록이 테이블로 표시됩니다
    - 테이블에서 공부하기 모드와 동일한 기능을 사용할 수 있습니다 (텍스트 보임/숨김, 클립보드 복사, 발음 재생 등)
